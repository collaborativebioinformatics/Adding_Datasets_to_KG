...
################################################################################
# Load goldenKG_v2 dataset to Neptune using bulk loader
#
# This script:
# 1. Uploads goldenKG_v2 nodes and edges to S3
...
# Configuration for new Neptune cluster
NEPTUNE_ENDPOINT="midas-dev-2510031321.cluster-c7j2zglv4rfb.us-east-1.neptune.amazonaws.com"
REGION="us-east-1"
S3_BUCKET="neptune-midas-dev-2510031321-989002774737"
IAM_ROLE_ARN="arn:aws:iam::989002774737:role/neptune-midas-dev-2510031321-NeptuneS3Role-Qi4mq1r1pCvA"

# Data paths
NODES_FILE="data_output/kgs/goldenKG_v2/goldenKG_v2_nodes_fixed.csv"
EDGES_FILE="data_output/kgs/goldenKG_v2/goldenKG_v2_edges_fixed.csv"

# S3 paths
S3_PREFIX="goldenKG_v2"
...
# Display summary
echo "================================================"
echo "Neptune Bulk Load Configuration - goldenKG_v2"
echo "================================================"
...
echo ""
echo "================================================"
log_success "goldenKG_v2 load completed successfully!"
echo "================================================"
echo ""
...
echo ""
echo "Summary:"
echo "  Total Nodes Loaded: ~2.6M"
echo "  Total Edges Loaded: ~6.0M"
echo ""
